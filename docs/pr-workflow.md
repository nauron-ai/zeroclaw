# LabaClaw PR Workflow (High-Volume Collaboration)

This document defines how LabaClaw handles high PR volume while maintaining:
...
- If identity-like wording appears in tests/examples, it is normalized to LabaClaw/project-native labels.
...
- Confirm any required identity-like wording uses LabaClaw/project-native terminology.
