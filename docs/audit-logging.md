...
## Problem
LabaClaw logs actions but lacks tamper-evident audit trails for:
...
# Tamper evidence
sign_events = true
signing_key_path = "~/.config/labaclaw/audit.key"
...
labaclaw audit --user @alice

# Show all high-risk commands
labaclaw audit --risk high

# Show violations from last 24 hours
labaclaw audit --since 24h --violations-only

# Export to JSON for analysis
labaclaw audit --format json --output audit.json
