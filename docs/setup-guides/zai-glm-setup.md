...
LabaClaw supports Z.AI's GLM models through OpenAI-compatible endpoints.
This guide covers practical setup options that match current LabaClaw provider behavior.

## Overview

LabaClaw supports these Z.AI aliases and endpoints out of the box:
...
### Test with LabaClaw CLI

```bash
# Test agent directly
echo "Hello" | labaclaw agent
